...
#This says that the messages'resources are apart of the conversation
  ...
  get '/national_geographic', to: 'pages#national_geographic'
  get '/people_magazine', to: 'pages#people_magazine'
  get '/time_magazine', to: 'pages#time_magazine'
  get '/sports_ilustrated', to: 'pages#sports_ilustrated'
  get '/cosmopolitan', to: 'pages#cosmopolitan'
  get '/redbull', to: 'pages#redbull'
  get '/espn', to: 'pages#espn'
  get '/us_weekly', to: 'pages#us_weekly'
  get '/entertainment_weekly', to: 'pages#entertainment_weekly'
  get '/newsweek', to: 'pages#newsweek'
  get '/popular_science', to: 'pages#popular_science'
  get '/vogue', to: 'pages#vogue'
  get '/bloomberg_businessweekly', to: 'pages#bloomberg_businessweekly'
  get '/gq', to: 'pages#gq'
  get '/hgtv', to: 'pages#hgtv'
  get '/forbes_magazine', to: 'pages#forbes_magazine'
  get '/fortune', to: 'pages#fortune'
  get '/e_news', to: 'pages#e_news'
