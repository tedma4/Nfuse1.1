Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  #       scope: "plus.me,
  #               plus.stream.read, https://www.googleapis.com/auth/plus.me"
  provider :google_oauth2, ENV["google_client_id"],         ENV["google_client_secret"],
    {
      :provider_ignores_state => true,
      :scope => "userinfo.email, userinfo.profile, plus.me, http://gdata.youtube.com, https://www.googleapis.com/auth/plus.me",
      :prompt => "consent",
