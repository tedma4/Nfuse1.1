...
(function() { this.JST || (this.JST = {}); this.JST["templates/create_post"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<!-- This page is the embedded savascript layout for posting to faceebook and twitter -->\n<div id="create_posts_container">\n  <form id="create_post_form" action="#" data-behavior="/posts">\n    <div style="display:none">\n      <input name="utf8" type="hidden" value="&#x2713;"/>\n      <input name="authenticity_token" type="hidden" value="sx9Uqe9Rt0WYna5MBqHA/bDQmJJfrE8c/sIUjiQJN/w="/>\n    </div>\n\n    <label for="post_content">Post content</label>\n    <textarea id="post_content" name="post"></textarea>\n\n    ');  if (twitter) { ; __p.push('\n    <label for="provider_twitter">Post to Twitter</label>\n    <input id="provider_twitter" name="provider[twitter]" type="checkbox" value="0"/>\n    ');  } ; __p.push('\n\n    ');  if (facebook) { ; __p.push('\n    <label for="provider_facebook">Post to Facebook</label>\n    <input id="provider_facebook" name="provider[facebook]" type="checkbox" value="0"/>\n    ');  } ; __p.push('\n\n    <input type="submit" value="Create Post"/>\n  </form>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/facebook_post"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<!-- This page is the embedded savascript for posting to faceebook -->\n<div class="individual_post facebook_post">\n  <div class="network_logo">\n    <img src="/assets/FB-f-Logo__blue_50.png" class="provider_logo">\n  </div>\n  <div class="post_main">\n    <div class="post_header">\n      <ul id="facebook_post_header">\n        <li>\n          <a href="',  "https://www.facebook.com/app_scoped_user_id/" + from.id ,'" target="_blank"><img src="',  profile_picture_url ,'" class="user_profile_picture"></a>\n        </li>\n        <li><a href="',  "https://www.facebook.com/app_scoped_user_id/" + from.id ,'"\n               target="_blank">',  from.name ,'</a></li>\n        <li>',  created_time ,'</li>\n      </ul>\n      <div class="subheader">\n        <ul>\n          <li>via ',  application.name ,'</li>\n        </ul>\n      </div>\n    </div>\n    <div class="post_content">\n      <ul>\n        <li>',  message ,'</li>\n      </ul>\n      <div class="post_stats">\n        <ul>\n          <li>Comments: 0</li>\n          <li data-facebook-like-count="',  id ,'">\n            <a href="',  "/facebook/like/" + id ,'">Like:</a> <span class="js-facebook-like-count">0</span>\n          </li>\n          <li>\n            <a href="',  actions[0].link ,'" target="_blank">View on Facebook</a>\n          </li>\n        </ul>\n      </div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/twitter_post"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<!-- This page is the embedded savascript for posting to twitter -->\n<div class="individual_post twitter_post" data-id="',  id ,'">\n  <div class="network_logo">\n    <img src="/assets/Twitter_logo_blue.png" class="provider_logo">\n  </div>\n  <div class="post_main">\n    <div class="post_header">\n      <ul>\n        <li>\n          <a href="',  "https://twitter.com/" + user.screen_name ,'" target="_blank">\n            <img src="',  user.profile_image_url_https ,'" class="user_profile_picture">\n          </a>\n        </li>\n        <li><a href="',  "https://twitter.com/" + user.screen_name ,'" target="_blank">',  user.name ,'</a></li>\n        <li>@',  user.screen_name ,'</li>\n        <li>',  created_at ,'</li>\n      </ul>\n    </div>\n    <div class="post_content">\n      <ul>\n        <li>',  text ,'</li>\n      </ul>\n      <div class="post_stats">\n        <ul>\n          <li data-twitter-retweet-count>\n            <a href="',  "/twitter/retweet/" + id ,'">Retweet:</a> <span class="js-twitter-retweet-count">',  retweet_count ,'</span>\n          </li>\n          <li data-twitter-favorite-count="',  id ,'">\n            <a href="',  "/twitter/favorite/" + id ,'">Favorite:</a> <span class="js-twitter-favorite-count">',  favorite_count ,'</span>\n          </li>\n          <li>\n            <a href="',  "https://twitter.com/" + user.screen_name + "/status/" + id ,'" target="_blank">View on Twitter</a>\n          </li>\n        </ul>\n      </div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
$(document).ready(function(){
